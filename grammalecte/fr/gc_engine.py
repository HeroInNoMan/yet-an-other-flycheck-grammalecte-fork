...
def s_num_grand_nombre_soudé_1 (s, m):
...
def c_conf_se_verbe1_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morph(dDA, (m.start(2), m.group(2)), ":Y")  and m.group(1) != "CE"
def c_conf_se_verbe2_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morph(dDA, (m.start(2), m.group(2)), ":V[123].*:(?:Y|[123][sp])") and not morph(dDA, (m.start(2), m.group(2)), ">(?:devoir|pouvoir|sembler) ") and m.group(2)[0].islower() and m.group(1) != "CE"
...
def c_conf_différend_1 (s, sx, m, dDA, sCountry, bCondMemo):
...
def c_conf_son_qqch_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, (m.start(2), m.group(2)), ":[NA].*:[me]:s|>[aeéiîou].* :[NA].*:f:s", ":[GW]") and morphex(dDA, prevword1(s, m.start()), ":V|>(?:à|avec|chez|dès|contre|devant|derrière|en|par|pour|sans|sur) ", ":[NA].*:[pi]|>(?:ils|elles|vous|nous|leur|lui|[mts]e) ", True) and not look(s[:m.start()], r"(?i)\bce que? |[mts]’en +$")
...
def c_p_astuce_désambiguïsation1_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return isAmbiguousNAV(m.group(3)) and morphex(dDA, (m.start(1), m.group(1)), ":[NAQ]", ">telle ")
def c_p_astuce_désambiguïsation2_1 (s, sx, m, dDA, sCountry, bCondMemo):
...
def c_p_astuce_désambiguïsation3_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return isAmbiguousNAV(m.group(3)) and ( morphex(dDA, (m.start(1), m.group(1)), ":[NAQ]", ":V0a") or (morphex(dDA, (m.start(1), m.group(1)), ":[NAQ]", ":(?:3[sp]|V0a)") and look(s[:m.start()], "^ *$|, *$")) )
...
def c_ppas_je_me_être_verbe_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, (m.start(1), m.group(1)), ":Q.*:p", ":(?:G|Q.*:[si])") and look(s[m.end():], "^ *$") and not look(s[:m.start()], r"\b[qQ]ue? +$")
def c_ppas_tu_te_être_verbe_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, (m.start(1), m.group(1)), ":Q.*:p", ":(?:G|Q.*:[si])") and look(s[m.end():], "^ *$") and not look(s[:m.start()], r"\b[qQ]ue? +$")
def c_ppas_il_se_être_verbe_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, (m.start(1), m.group(1)), ":Q.*:(?:f|m:p)", ":(?:G|Q.*:m:[si])") and look(s[m.end():], "^ *$") and not look(s[:m.start()], r"\b[qQ]ue? +$")
def c_ppas_elle_se_être_verbe_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, (m.start(1), m.group(1)), ":Q.*:(?:m|f:p)", ":(?:G|Q.*:f:[si])") and look(s[m.end():], "^ *$") and not morph(dDA, prevword1(s, m.start()), ":R|>que ", False, False)
def c_ppas_nous_nous_être_verbe_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, (m.start(1), m.group(1)), ":Q.*:s", ":(?:G|Q.*:[pi])") and look(s[m.end():], "^ *$") and not morph(dDA, prevword1(s, m.start()), ":R|>que ", False, False)
def c_ppas_ils_se_être_verbe_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, (m.start(1), m.group(1)), ":Q.*:(?:f|m:s)", ":(?:G|Q.*:m:[pi])") and look(s[m.end():], "^ *$") and not look(s[:m.start()], r"\b[qQ]ue? +$")
def c_ppas_elles_se_être_verbe_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, (m.start(1), m.group(1)), ":Q.*:(?:m|f:s)", ":(?:G|Q.*:f:[pi])") and look(s[m.end():], "^ *$") and not morph(dDA, prevword1(s, m.start()), ":R|>que ", False, False)
...
def c_ppas_je_verbe_être_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morph(dDA, (m.start(1), m.group(1)), ">(?:sembler|para[îi]tre|pouvoir|penser|préférer|croire|d(?:evoir|éclarer|ésirer|étester|ire)|vouloir|affirmer|aimer|adorer|souhaiter|estimer|imaginer|risquer) ", False) and morphex(dDA, (m.start(2), m.group(2)), ":[NAQ].*:p", ":[GWYsi]")
...
def c_ppas_il_verbe_être_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morph(dDA, (m.start(2), m.group(2)), ">(?:sembler|para[îi]tre|pouvoir|penser|préférer|croire|d(?:evoir|éclarer|ésirer|étester|ire)|vouloir|affirmer|aimer|adorer|souhaiter|estimer|imaginer|risquer) ", False) and (morphex(dDA, (m.start(3), m.group(3)), ":[NAQ].*:p", ":[GWYsi]") or morphex(dDA, (m.start(3), m.group(3)), ":[AQ].*:f", ":[GWYme]"))
def s_ppas_il_verbe_être_1 (s, m):
    return suggMasSing(m.group(3))
def c_ppas_ça_verbe_être_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morph(dDA, (m.start(2), m.group(2)), ">(?:sembler|para[îi]tre|pouvoir|penser|préférer|croire|d(?:evoir|éclarer|ésirer|étester|ire)|vouloir|affirmer|aimer|adorer|souhaiter|estimer|imaginer|risquer) ", False) and (morphex(dDA, (m.start(3), m.group(3)), ":[NAQ].*:p", ":[MWYsi]") or morphex(dDA, (m.start(3), m.group(3)), ":[AQ].*:f", ":[GWYme]")) and not morph(dDA, prevword1(s, m.start()), ":R", False, False)
def s_ppas_ça_verbe_être_1 (s, m):
    return suggMasSing(m.group(3))
def c_ppas_elle_verbe_être_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morph(dDA, (m.start(2), m.group(2)), ">(?:sembler|para[îi]tre|pouvoir|penser|préférer|croire|d(?:evoir|éclarer|ésirer|étester|ire)|vouloir|affirmer|aimer|adorer|souhaiter|estimer|imaginer|risquer) ", False) and (morphex(dDA, (m.start(3), m.group(3)), ":[NAQ].*:p", ":[GWYsi]") or morphex(dDA, (m.start(3), m.group(3)), ":[AQ].*:m", ":[GWYfe]")) and not morph(dDA, prevword1(s, m.start()), ":R", False, False)
def s_ppas_elle_verbe_être_1 (s, m):
    return suggFemSing(m.group(3))
def c_ppas_elle_qui_verbe_être_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morph(dDA, (m.start(2), m.group(2)), ">(?:sembler|para[îi]tre|pouvoir|penser|préférer|croire|d(?:evoir|éclarer|ésirer|étester|ire)|vouloir|affirmer|aimer|adorer|souhaiter|estimer|imaginer|risquer) ", False) and (morphex(dDA, (m.start(3), m.group(3)), ":[NAQ].*:p", ":[MWYsi]") or morphex(dDA, (m.start(3), m.group(3)), ":[AQ].*:m", ":[GWYfe]"))
def s_ppas_elle_qui_verbe_être_1 (s, m):
    return suggFemSing(m.group(3))
def c_ppas_nous_verbe_être_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return not re.search("(?i)^légion$", m.group(2)) and morph(dDA, (m.start(1), m.group(1)), ">(?:sembler|para[îi]tre|pouvoir|penser|préférer|croire|d(?:evoir|éclarer|ésirer|étester|ire)|vouloir|affirmer|aimer|adorer|souhaiter|estimer|imaginer|risquer) ", False) and morph(dDA, (m.start(1), m.group(1)), ":1p", False) and morphex(dDA, (m.start(2), m.group(2)), ":[NAQ].*:s", ":[GWYpi]")
def s_ppas_nous_verbe_être_1 (s, m):
    return suggPlur(m.group(2))
def c_ppas_ils_verbe_être_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return not re.search("(?i)^légion$", m.group(3)) and morph(dDA, (m.start(2), m.group(2)), ">(?:sembler|para[îi]tre|pouvoir|penser|préférer|croire|d(?:evoir|éclarer|ésirer|étester|ire)|vouloir|affirmer|aimer|adorer|souhaiter|estimer|imaginer|risquer) ", False) and (morphex(dDA, (m.start(3), m.group(3)), ":[NAQ].*:s", ":[GWYpi]") or morphex(dDA, (m.start(3), m.group(3)), ":[AQ].*:f", ":[GWYme]")) and (not re.search("^(?:ceux-(?:ci|là)|lesquels)$", m.group(1)) or not morph(dDA, prevword1(s, m.start()), ":R", False, False))
def s_ppas_ils_verbe_être_1 (s, m):
    return suggMasPlur(m.group(3))
def c_ppas_elles_verbe_être_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return not re.search("(?i)^légion$", m.group(3)) and morph(dDA, (m.start(2), m.group(2)), ">(?:sembler|para[îi]tre|pouvoir|penser|préférer|croire|d(?:evoir|éclarer|ésirer|étester|ire)|vouloir|affirmer|aimer|adorer|souhaiter|estimer|imaginer|risquer) ", False) and (morphex(dDA, (m.start(3), m.group(3)), ":[NAQ].*:s", ":[GWYpi]") or morphex(dDA, (m.start(3), m.group(3)), ":[AQ].*:m", ":[GWYfe]")) and (not re.search("^(?:elles|celles-(?:ci|là)|lesquelles)$", m.group(1)) or not morph(dDA, prevword1(s, m.start()), ":R", False, False))
...
def c_ppas_det_nom_avoir_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return not re.search("(?i)^(?:barre|confiance|cours|envie|peine|prise|crainte|cure|affaire|hâte|force|recours)$", m.group(4)) and morph(dDA, prevword1(s, m.start()), ">puisque? ", False, True) and morph(dDA, (m.start(3), m.group(3)), ":V0a", False) and not m.group(4).isupper() and morphex(dDA, (m.start(4), m.group(4)), ":(?:[123][sp]|Q.*:[fp])", ":(?:G|W|Q.*:m:[si])")
...
def c_imp_union_le_la_leur_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, (m.start(1), m.group(1)), ":E", ":[GM]") and morphex(dDA, nextword1(s, m.end()), ":", ":(?:N|A|Q|Y|MP|H|T)", True) and morph(dDA, prevword1(s, m.start()), ":Cc", False, True) and not look(s[:m.start()], "~ +$")
...
def s_conj_det_sing_nom_pronom_1 (s, m):
    return suggVerb(m.group(3), ":3s")
def c_conj_det_nom_ambiguïté1_1 (s, sx, m, dDA, sCountry, bCondMemo):
...
def s_conj_det_nom_ambiguïté1_1 (s, m):
    return suggVerb(m.group(3), ":3s", suggSing)
def c_conj_det_nom_ambiguïté2_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, prevword1(s, m.start()), ":C", ":(?:Y|P)", True) and isVeryAmbiguousAndWrong(m.group(2), m.group(3), ":s", ":3s", look(s[:m.start()], "^ *$|, *$")) and not (look(s[:m.start()], r"(?i)\b(?:et|ou) +$") and morph(dDA, (m.start(3), m.group(3)), ":(?:[123]p|p)", False)) and not look(s[:m.start()], r"(?i)\bni .* ni\b")
def s_conj_det_nom_ambiguïté2_1 (s, m):
    return suggVerb(m.group(3), ":3s", suggSing)
...
def c_conj_det_plur_nom_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morph(dDA, (m.start(2), m.group(2)), ":[NAQ].*:[pi]", False) and morphex(dDA, (m.start(3), m.group(3)), ":V", ":(?:[13]p|P|Q|Y|G|A.*:e:[pi])") and morphex(dDA, prevword1(s, m.start()), ":C", ":[YP]", True) and not checkAgreement(m.group(2), m.group(3)) and not( morph(dDA, (m.start(3), m.group(3)), ":3s", False) and look(s[:m.start()], r"(?i)\b(?:l[ea] |l’|ce(?:tte|t|) |[mts](?:on|a) ).+ entre .+ et ") )
def s_conj_det_plur_nom_1 (s, m):
    return suggVerb(m.group(3), ":3p")
def c_conj_det_plur_nom_pronom_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morph(dDA, (m.start(2), m.group(2)), ":[NAQ].*:[pi]", False) and morphex(dDA, (m.start(3), m.group(3)), ":V", ":(?:[13]p|P|Y|G)") and morphex(dDA, prevword1(s, m.start()), ":C", ":[YP]", True) and not( morph(dDA, (m.start(3), m.group(3)), ":3s", False) and look(s[:m.start()], r"(?i)\b(?:l[ea] |l’|ce(?:tte|t|) |[mts](?:on|a) ).+ entre .+ et ") )
def s_conj_det_plur_nom_pronom_1 (s, m):
    return suggVerb(m.group(3), ":3p")
def c_conj_des_nom_1 (s, sx, m, dDA, sCountry, bCondMemo):
...
def s_conj_des_nom_qui_1 (s, m):
    return suggVerb(m.group(2), ":3p")
def c_conj_det_plur_nom_ambiguïté_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, prevword1(s, m.start()), ":C", ":[YP]", True) and isAmbiguousAndWrong(m.group(2), m.group(3), ":p", ":3p")
def s_conj_det_plur_nom_ambiguïté_1 (s, m):
    return suggVerb(m.group(3), ":3p", suggPlur)
def c_conj_les_nom_ambiguïté_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, prevword1(s, m.start()), ":C", ":[YP]", True) and isVeryAmbiguousAndWrong(m.group(1), m.group(2), ":p", ":3p", look(s[:m.start()], "^ *$|, *$"))
def s_conj_les_nom_ambiguïté_1 (s, m):
    return suggVerb(m.group(2), ":3p", suggPlur)
def c_conj_certains_nom_ambiguïté_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, prevword1(s, m.start()), ":C", ":[YP]", True) and isVeryAmbiguousAndWrong(m.group(1), m.group(2), ":m:p", ":3p", look(s[:m.start()], "^ *$|, *$"))
def s_conj_certains_nom_ambiguïté_1 (s, m):
    return suggVerb(m.group(2), ":3p", suggMasPlur)
def c_conj_certaines_nom_ambiguïté_1 (s, sx, m, dDA, sCountry, bCondMemo):
    return morphex(dDA, prevword1(s, m.start()), ":C", ":[YP]", True) and isVeryAmbiguousAndWrong(m.group(1), m.group(2), ":f:p", ":3p", look(s[:m.start()], "^ *$|, *$"))
def s_conj_certaines_nom_ambiguïté_1 (s, m):
